...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/bootstrap4-toggle.min.css') }}" integrity="sha512-EzrsULyNzUc4xnMaqTrB4EpGvudqpetxG/WNjCpG6ZyyAGxeB6OBF9o246+mwx3l/9Cn838iLIcrxpPHTiygAA=="
          crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ asset('logo.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
...
<script>
    ...
    function cropImage(idz,fromwhere)
    {
      var $modal = $('#modal');
$(".img_name").hide()
...
$("#crop").click(function(){
  ...
  canvas.toBlob(function(blob) {
    ...
    reader.onloadend = function() {
      ...
      var profile_name = document.getElementsByName(idz)[0].value      
      $.ajax({
        type: "POST",
        dataType: "json",
        url: "/crop-image-upload",
        data: {'_token': _token, 'image': base64data, 'profile_name': profile_name,'fromwhere':fromwhere},
